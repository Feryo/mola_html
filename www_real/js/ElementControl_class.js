class ElementControl {
	...
	masters(new_value) {
		if (new_value != undefined){
			Object.push(this.element['tech']['masters'], new_value);
		}
		return this.element['tech']['masters'];
	}
	slaves(new_value) {
		if (new_value != undefined){
			Object.push(this.element['tech']['slaves'], new_value);
		}
		return this.element['tech']['slaves'];
	}
	linked(new_value) {
		if (new_value != undefined){
			Object.push(this.element['tech']['linked'], new_value);
		}
		return this.element['tech']['linked'];
	}
	notlinked(new_value) {
		if (new_value != undefined){
			Object.push(this.element['tech']['notlinked'], new_value);
		}
		return this.element['tech']['notlinked'];
	}
	...
	target_masters(new_value) {
		if (new_value != undefined){
			Object.push(this.target_element['tech']['masters'], new_value);
		}
		return this.target_element['tech']['masters'];
	}
	target_slaves(new_value) {
		if (new_value != undefined){
			Object.push(this.target_element['tech']['slaves'], new_value);
		}
		return this.target_element['tech']['slaves'];
	}
	target_linked(new_value) {
		if (new_value != undefined){
			Object.push(this.target_element['tech']['linked'], new_value);
		}
		return this.target_element['tech']['linked'];
	}
	target_notlinked(new_value) {
		if (new_value != undefined){
			Object.push(this.target_element['tech']['notlinked'], new_value);
		}
		return this.target_element['tech']['notlinked'];
	}
	to_linear() {
		return 123;
	}
